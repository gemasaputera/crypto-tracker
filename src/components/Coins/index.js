        ...
        <div className={styles.coin_container}>
          <div className={styles.coin_row}>
            ...
            <div className={styles.coin_data}>
              <p className={styles.coin_price}>IDR {price.toLocaleString('id')}</p>
              <p className={styles.coin_volume}>{volume.toLocaleString('id')}</p> 
              ...
              <p className={styles.coin_marketcap}>Mkt Cap: {marketcap.toLocaleString('id')}</p>
            </div>
          </div>
        </div>
      </a>
